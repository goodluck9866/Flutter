	...
	<html lang="en">
		...
		<body class="">
			...
			<div class="wrapper ">
					                  ...
					                  <div class="nav-tabs-navigation">
					                    <div class="nav-tabs-wrapper">
					                      <ul class="nav nav-tabs" data-tabs="tabs">
					                      	<li class="nav-item">
					                          <a class="nav-link active" href="#PendingOrders" data-toggle="tab" onclick="updateOrderHistorytables('Pending','PendingOrdersTable','<?php echo $id; ?>');" id="PendingOrdersLink">
					                            <i class="material-icons">notifications</i> Pending Orders
					                            <div class="ripple-container"></div>
					                          </a>
					                        </li>
					                      	<li class="nav-item">
					                          <a class="nav-link " href="#ProcessingOrders" data-toggle="tab" onclick="updateOrderHistorytables('Processing','ProcessingOrdersTable','<?php echo $id; ?>');" id="PendingOrdersLink">
				...
				<script>
					updateOrderHistorytables('Pending','PendingOrdersTable','<?php echo $id; ?>');
					firebase.database().ref('Users/<?php echo $id; ?>/user_name').once('value',snap => {
						if (snap.exists()){
							       	var getcustomername=snap.val();
							       	document.getElementById("sNames").innerHTML=getcustomername+' ';
